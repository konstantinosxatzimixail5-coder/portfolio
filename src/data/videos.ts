...
export const clips: Record<string, Clip[]> = {
  'work:mariposa': [
    ...
    },
    {
      ...
      note: 'The terrace at dusk, built from the restaurant’s photography and map imagery. The tables, decking and central olive tree match the room a diner sees on arrival.',
      duration: '0:15',
      ratio: '9:16',
  ...
  'work:amino-alliance': [
    ...
    },
    {
      ...
      note: 'The same product in a second setting. A handheld camera places the speaker on an Amsterdam canal and keeps the piece inside the creator-ad register.',
      duration: '0:14',
      ratio: '9:16',
  ...
  'work:cocoon': [
    {
      ...
      note: 'The pilot film uses recorded footage from the solar park. It follows the van into Halkidiki, through the gate and into the control cabin, then closes on the researcher in front of the array.',
      duration: '1:48',
      ratio: '16:9',
