...
export const clips: Record<string, Clip[]> = {
  'work:mariposa': [
    ...
    },
    {
      ...
      note: 'The terrace at dusk, built from the restaurant’s own photography and its Google Maps imagery. The tables, decking and olive tree in the middle stand where they do in the room, so a diner who has eaten there recognises it.',
      duration: '0:15',
      ratio: '9:16',
  ...
  'work:amino-alliance': [
    ...
    },
    {
      ...
      note: 'The same product, a different decade and a different city. I placed the presenter on a canal and used a handheld camera so the advert reads as a person who happens to be outside.',
      duration: '0:14',
      ratio: '9:16',
    ...
    },
    {
      ...
      note: 'The performance angle, mid-session, shaker in hand on a winter path. I kept the same trained-identity discipline for a different audience and a different ask at the end.',
      duration: '0:13',
      ratio: '9:16',
  ...
  'work:cocoon': [
    {
      ...
      note: 'I set the objectives and two milestones as cards over the array, then placed a vertical site tour inside a solar-cell frame: the van, the drive to Halkidiki, the gate, the control cabin, the inverter and the logging kit. The film closes on the HEDNO researcher in front of the rows. This is the one piece in the engagement built from footage.',
      duration: '1:48',
      ratio: '16:9',
  ...
  'work:jarfis-property-group': [
    {
      ...
      note: 'A presenter speaks beside a listed villa with the phone and tripod left in frame. I reconstructed the property from the client’s stills and matched the grade to the listing photography.',
      duration: '0:10',
      ratio: '9:16',
