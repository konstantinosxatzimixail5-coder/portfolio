// The three original shorts.
//
// Every field below that the brief marks "verbatim from the PDF" was extracted
// from the process document with pypdf and reflowed by script, then proofread
// block by block against the page. Nothing here was retyped, which is the only
// way fourteen prompts arrive with their timecodes and reference tags intact.
//
// Sources: TwinMoons_Process_TaleCrafters.pdf and Skyrunner_Process_TaleCrafters.pdf,
// eleven sheets each, both committed under public/docs/.
//
// Mars Drop is the third and the odd one out. It has no sheet under public/docs/
// yet, so its page omits the reader; everything on it was written from the cut
// and the beat map rather than lifted from a PDF. It is also the only one of the
// three built scene by scene out of an episodic engine rather than shot by shot
// out of a video model, which is why its stack note reads the way it does.
...
export interface Film {
  ...
  // The process sheet, once it is written and committed under public/docs/.
  // Optional because a film can be published before its sheet is: the page omits
  // the reader rather than pointing at a file that is not there. See docExists.
...
Style, light, colour, materials and every surface in the shot come from @spires_v1 and the character references.`,
...

  {
    ...
    standfirst:
      'A 107-second comedy scene built to test whether an episodic production system can hold two characters through dialogue alone.',
    logline:
    ...
    closing: 'site/mars-drop/md-d-address',
    closingAlt:
    ...
    beats: [
      {
        ...
        span: '0:00 – 0:26',
        name: 'Arrival',
        image: 'site/mars-drop/md-poster',
      ...
      },
      {
        ...
        span: '0:26 – 0:52',
        name: 'Act natural',
        image: 'site/mars-drop/md-b-natural',
      ...
      },
      {
        ...
        image: 'site/mars-drop/md-hero',
        alt: 'A single of the executive at the foot of the booster, arms open in a shrug, two moons and a rock face behind him.',
        note: 'The turn. He works out what they are in, and the shrug lands one beat ahead of the line.',
        prompt:
      ...
      },
      {
        ...
        image: 'site/mars-drop/md-d-address',
        ...
        prompt:
          'Medium single, same setup as beat B. The man in the black suit plants both hands on his hips and leans a few degrees toward camera, chin lifted, with his eyeline fixed just off lens. Water tower and orange dunes behind, unchanged. Hold, then cut to the beat A wide, identical framing, both figures back in position.',
      },
    ],
    castIntro:
    ...
    pipeline: [
      ...
      },
      {
        ...
        name: 'Fix the beats',
        tool: 'Four blocks',
        body: 'Arrival, act natural, the demonstration and the notes. Each beat keeps one camera position. The beat map fixes the cutting pattern.',
      },
      {
        num: '03',
      ...
      },
      {
        ...
        tool: 'Higgsfield',
        body: 'Motion on each block follows the listener. The reaction comes first and the line is timed to it.',
      },
      {
        num: '06',
        name: 'Voice',
        tool: 'ElevenLabs',
        body: 'Two reads, cut against picture. Both were retimed after the motion pass because a line arriving on the gesture reads as a puppet.',
      },
      {
        num: '07',
        name: 'Assembly',
    ...
    tools: [
      ...
      { name: 'ElevenLabs', role: 'Voice', body: 'Both reads, retimed against the finished motion.' },
    ...
    locks: [
      ...
      },
      {
        ...
        symptom: 'Lines landed on the movement, which made the characters read as lip-synced puppets.',
        lock: 'Voice is cut last against picture, with every read timed after the motion pass.',
      },
    ],
  },
];
