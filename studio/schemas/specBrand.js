...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        'Anything from this set that moves. Two of these brands end on an anamorphic billboard, which is the frame the stills cannot make the argument for on their own.',
    }),
  ],
